"""Estimator backend -- CORE, author-written (CLAUDE.md s3).
...
the sensor fusion are the author's to write and defend. Everything around this
package (data, frontend, viz, eval) is plumbing and is complete.
"""
